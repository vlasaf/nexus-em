...
const steps = [
  {
    icon: Database,
    title: "Оцифровка штата",
    description: "Загружаем данные из HR-систем, проводим оценку компетенций и психотипов сотрудников",
    color: "text-chart-1",
  ...
  },
  {
    ...
    description: "AI анализирует совместимость, риски, сильные стороны. Визуализируем в дашбордах",
    color: "text-chart-3",
  ...
  },
  {
    icon: Lightbulb,
    title: "Рекомендации",
    description: "Копилот предлагает действия: кого нанять, кого продвинуть, где риски конфликтов",
    color: "text-chart-4",
