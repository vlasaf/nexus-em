...
const solutions = [
  "Точное AI-психопрофилирование каждого человека",
  "AI-расшифровка характеристик и инструкции по работе",
  "Прогноз совместимости на основе психопрофилей",
  "Персональные рекомендации для руководителей",
  "Научно валидированная методология оценки",
