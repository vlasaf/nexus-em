...
const solutions = [
  "Психопрофилирование на основе валидированной методологии",
  "AI-расшифровка характеристик и инструкции по работе",
  "AI-прогноз совместимости на основе психопрофилей",
  "Персональные AI-рекомендации для руководителей",
  "Научная точность, подтвержденная метаанализами",
  "Real-time дашборды психопрофилей команды",
];
