...
const integrations = [
  { icon: Users, name: "ATS системы", description: "HH.ru, Talantix, SmartStaff" },
  { icon: Database, name: "HRIS", description: "SAP, 1C, Битрикс24" },
  { icon: Calendar, name: "Календари", description: "Google Calendar, Outlook" },
  { icon: Mail, name: "Email", description: "Gmail, Outlook, Яндекс" },
  { icon: FileSpreadsheet, name: "Таблицы", description: "Excel, Google Sheets" },
  { icon: Plug, name: "API", description: "REST API для кастомных интеграций" },
];
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 rounded-xl border bg-card p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Или используйте импорт данных через Excel/CSV
            </p>
          </div>
        </div>
      </div>
