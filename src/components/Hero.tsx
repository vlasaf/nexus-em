...
export const Hero = ({ onOpenDemo, onOpenCalculator }: HeroProps) => {
  return (
      ...
      <div className="container relative mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground sm:text-xl">
            Оцифровка штата • Best-candidate selection • Прогноз рисков и совместимости • 
            AI-подсказки действий • Прозрачные дашборды
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="rounded-xl border bg-card p-6 shadow-sm transition-shadow hover:shadow-md">
              ...
              <div className="text-sm text-muted-foreground">Ранняя текучесть в 90 дней</div>
            </div>
            
            <div className="rounded-xl border bg-card p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-2 text-3xl font-bold text-primary">-20%</div>
              <div className="text-sm text-muted-foreground">Time-to-fill позиций</div>
            </div>
